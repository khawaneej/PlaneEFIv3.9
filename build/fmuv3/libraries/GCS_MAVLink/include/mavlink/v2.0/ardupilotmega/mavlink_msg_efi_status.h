...
typedef struct __mavlink_efi_status_t {
 ...
 float ignition_timing; /*< [Crank Angle degrees] Ignition timing for cylinder i (Crank Angle degrees)*/
 ...
 * @param ignition_timing [Crank Angle degrees] Ignition timing for cylinder i (Crank Angle degrees)
 ...
 *
 * @return [Crank Angle degrees] Ignition timing for cylinder i (Crank Angle degrees)
 */
